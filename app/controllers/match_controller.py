...
async def abandon_match(match: AbandonMatch, authorization: Union[str, None] = Header(None)):
    ...
    if not match_dao.update_abandoning_user(abandoning_user, match):
        raise ERROR_DELETING_USER

    ## SEND INFORMATION TO WEB SOCKETS
