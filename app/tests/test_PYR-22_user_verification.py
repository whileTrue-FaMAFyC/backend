...
from app.database.crud.user import create_user, delete_user_by_username
from app.schema.user import NewUserToDb

client = TestClient(app)

def test_successful_verification():
    # If exists deletes the user from the database
